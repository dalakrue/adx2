"""Compatibility loader for the refactored `core/ui/legacy_impl/styles_impl.py` module.

The original large file was split into `styles_impl_parts/part_*.py` chunks so no
...
_PARTS_PACKAGE = (__package__ + '.styles_impl_parts') if __package__ else 'styles_impl_parts'
_PART_COUNT = 4
