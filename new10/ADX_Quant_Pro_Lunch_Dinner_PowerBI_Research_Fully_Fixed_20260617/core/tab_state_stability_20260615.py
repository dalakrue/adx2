...
SUBPAGES: Dict[str, List[str]] = {
    ...
    "Research": ["", "AI Assistant", "KNN / Greedy", "Quant Structure"],
}
ALIASES = {
    "Home": "Lunch", "Data Visualization": "Lunch", "AI Assistant": "Research", "Doo Prime": "Morning",
    "Regime": "Dinner", "Data Analysis": "Research", "Power BI": "Lunch", "PowerBI": "Lunch", "Metric": "Lunch",
}
...
def stabilize_tab_state() -> None:
    ...
    page = ALIASES.get(_clean_text(ss.get("active_page"), "Settings"), _clean_text(ss.get("active_page"), "Settings"))
