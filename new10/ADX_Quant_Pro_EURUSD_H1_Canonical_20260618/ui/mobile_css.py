...
def inject_mobile_css() -> None:
    ...
    phone_css = """
    .main .block-container{max-width:100%!important;padding-left:.38rem!important;padding-right:.38rem!important;padding-top:.42rem!important}
    .stApp{font-size:18px!important}
    .stButton>button{min-height:54px!important;font-size:1rem!important;padding:.62rem .68rem!important}
    [data-testid="stMetric"]{padding:.72rem .70rem!important;min-height:116px!important}
    [data-testid="stMetricValue"]{font-size:1.55rem!important;line-height:1.08!important}
    [data-testid="stMetricLabel"]{font-size:.92rem!important}
    input,textarea,[data-baseweb="select"]>div{font-size:1rem!important;min-height:50px!important}
    div[data-testid="stDataFrame"]{font-size:.90rem!important}
    section[data-testid="stSidebar"]{min-width:min(92vw,390px)!important;max-width:min(92vw,390px)!important}
    """ if phone else ""
    st.markdown(f"""
<style id="new7-future-mobile-css-20260617">
