...
from core.connectors.data_parts.session import manual_connect, maybe_refresh, connect_history_60d
...
__all__ = [
    ...
    "fetch_doo_bridge", "manual_connect", "maybe_refresh", "mt5_account_info",
