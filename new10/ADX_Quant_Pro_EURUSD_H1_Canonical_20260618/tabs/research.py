...
def show() -> None:
    ...
    c[1].metric("Research Cache", "READY" if st.session_state.get("research_pack_20260612") else "NOT BUILT", "Use Build / Refresh below")
    try:
    ...
    if "research_pack_20260612" not in st.session_state:
        st.info("Research pack is not built yet. Use Build / Refresh Research Pack; tab switching does not start heavy calculations automatically.")
    else:
