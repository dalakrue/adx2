...
def test_active_routes_have_one_settings_owner_and_no_second_load_gate():
    ...
    assert "run_settings_calculation" not in menu
    assert "from core.settings_run_orchestrator_20260617 import run_settings_calculation" not in popup
    assert "Settings is the only owner of the protected run_settings_calculation transaction" in popup
