...
def build_current_home_payload(short: bool = False) -> str:
    ...
    try:
        ...
        from services.canonical_exports import short_text, all_text
        ...
        return short_text(canonical, summary, plan, st.session_state) if short else all_text(canonical, summary, plan, readiness, st.session_state)
